...
export async function loader() {
  const tableData = await import("app/dashboard/data.json")
  const cardData = [
    {
      title: "Active Users",
      value: "110",
  ...
  return { cardData, chartData, tableData: tableData.default }
}
export default function Page({ loaderData }: any) {
  const { cardData, chartData, tableData } = loaderData
  return (
    <>
